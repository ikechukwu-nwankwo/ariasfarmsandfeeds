    ...
    <div class="page-contain">
        ...
        <div id="main-content" class="main-content">
                ...
                <ul class="biolife-carousel" data-slick='{"arrows": true, "dots": false, "slidesMargin": 0, "slidesToShow": 1, "infinite": false, "speed": 800}'>
                    <li>
                        <div class="slide-contain slider-opt03__layout02 slide_animation type_02">
                            ...
                            <div class="text-content">
                                <i class="first-line">Broiler Feeds</i>
                                <h6 class="second-line">Starter & Finisher</h6>
                                <p class="third-line">meticulously formulated to provide the essential nutrients needed for...</p>
                                <p class="buttons">
                                    <a href="broiler-starter-and-finisher-feeds" class="btn btn-bold">Read More</a>
                                </p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="slide-contain slider-opt03__layout02 slide_animation type_02">
                            ...
                            <div class="text-content">
                                <i class="first-line">Piggery Farm</i>
                                <h6 class="second-line">Expert Training & Product Sale</h6>
                                <p class="third-line">our piggery farm is a state-of-the-art facility dedicated to...</p>
                                <p class="buttons">
                                    <a href="piggery-farm" class="btn btn-bold">Read More</a>
                                </p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="slide-contain slider-opt03__layout02 slide_animation type_02">
                            <div class="media background-geen-01"></div>
                            <div class="text-content">
                                <i class="first-line">Agro Inputs & Fertilizers</i>
                                <h3 class="second-line">100% Organic & Healthy</h3>
                                <p class="third-line">we offer a wide range of high-quality agro input supplies...</p>
                                <p class="buttons">
                                    <a href="agro-input-supplies" class="btn btn-bold">Read More</a>
                                </p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="slide-contain slider-opt03__layout02 slide_animation type_02">
                            <div class="media background-geen-02"></div>
                            <div class="text-content">
                                <i class="first-line">Trainings</i>
                                <h3 class="second-line">Experienced Experts</h3>
                                <p class="third-line">we are committed to promoting sustainable farming practices that enhance...</p>
                                <p class="buttons">
                                    <a href="adaptation-techniques-and-climate-smart-farming" class="btn btn-bold">Read More</a>
                                </p>
                            </div>
                        </div>
                    </li>
                                ...
                                <div class="banner-contain">
                                    <div class="media">
                                        <a href="#" class="bn-link">
                                            <figure><img src="assets/images/home-03/ariashome.png" width="616" height="391" alt=""></figure>
                                        </a>
                                    </div>
                                    <div class="text-content">
                                        <b class="first-line">One Stop Place</b>
                                        <span class="second-line">For all your Farm inputs, feeds and services</span>
                                        <span class="third-line">Well <i>Prepared and Healthy</i></span>
                                        <div class="product-detail">
                                            ...
                                            <div class="buttons">
                                                <a href="about-us" class="btn add-to-cart-btn"></i>Read More</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <ul class="services-list">
                            ...
                            <li>
                                <div class="service-inner color-reverse">
                                    ...
                                    <a class="srv-name" href="#">prompt and delivery on time</a>
                                </div>
                            </li>
                            <li>
                                <div class="service-inner color-reverse">
                                    ...
                                    <a class="srv-name" href="#">delivery nationwide and Africa</a>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="product-tab z-index-20 sm-margin-top-193px xs-margin-top-30px">
                <div class="container">
                    <div class="biolife-title-box">
                        ...
                        <h3 class="main-title">Products (Feeds)</h3>
                    </div>
                    <div class="biolife-tab biolife-tab-contain sm-margin-top-34px">
                        <div class="tab-head tab-head__icon-top-layout icon-top-layout">
                            <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                                <li class="tab-element active">
                                    <a href="#tab01_1st" class="tab-link">Broiler</a>
                                </li>
                                <li class="tab-element">
                                    <a href="#tab01_2nd" class="tab-link">Layer</a>
                                </li>
                                <li class="tab-element">
                                    <a href="#tab01_3rd" class="tab-link">Turkey</a>
                                </li>
                                <li class="tab-element">
                                    <a href="#tab01_4th" class="tab-link">Rabbit</a>
                                </li>
                                <li class="tab-element">
                                    <a href="#tab01_5th" class="tab-link">Fish</a>
                                </li>
                            </ul>
                        </div>
                                        ...
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="assets/images/products/demo-270x270.jpg" alt="products" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <!--<a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>-->
                                            </div>
                                            <div class="info">
                                                <b class="categories">Broilers</b>
                                                <h4 class="product-title"><a href="#" class="pr-name">Organic and well prepared</a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">NGN</span>0000</span></ins>
                                                    <del><span class="price-amount"><span class="currencySymbol">NGN</span>0000</span></del>
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message">All feeds are carefully selected and prepared.</p>
                                                    <div class="buttons">
                                                        <!--<a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>-->
                                                        <a href="#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>add to cart</a>
                                                        <a href="place-order" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>place order</a>
                    ...
                    <div class="banner-contain">
                        ...
                        <div class="text-content">
                            <div class="container text-wrap">
                                <span class="first-line">Our Success Stories</span>
                                <p class="third-line"><b>Arias Farms and Feeds</b> have been in the business of transforming poultry farming in Rivers State Arias Farms and Feeds partnered with local poultry farmers in Rivers State to provide high-quality feeds and training programs.</p>
                                <div class="product-detail">
                                    <a href="our-success-stories" class="btn add-to-cart-btn">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="banner-promotion-01 xs-margin-top-50px sm-margin-top-70px">
                <div class="biolife-banner promotion3 biolife-banner__promotion3 green-style">
                    <div class="banner-contain">
                        ...
                        <div class="text-content">
                            <div class="container text-wrap">
                                <span class="first-line">Testimonials</span>
                                <p class="third-line">"<b>Arias Farms and Feeds has transformed my poultry business. The quality of their broiler and layer feeds is unmatched. My chickens are healthier, and... <br> <b>John Pepple - Poultry Farmer</b></p>
                                <div class="product-detail">
                                    <a href="testimonials" class="btn add-to-cart-btn">Read More Testimonials</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="brand-slide sm-margin-top-100px background-fafafa xs-margin-top-80px xs-margin-bottom-80px">
                <div class="container">
                    <h3 class="main-title" style="text-align:center; font-weight:bold">Our Clientele</h3>
                    ...
                    <ul class="biolife-carousel nav-center nav-none-on-mobile xs-margin-top-36px" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":3, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 3}},{"breakpoint":992, "settings":{ "slidesToShow": 2}},{"breakpoint":768, "settings":{ "slidesToShow": 2}},{"breakpoint":600, "settings":{ "slidesToShow": 1}}]}'>
                        <li>
                            <div class="post-item style-bottom-info layout-02 ">
                                <div class="thumbnail">
                                    <a href="blog-post" class="link-to-post"><img src="assets/images/our-blog/demo-1.jpg" width="370" height="270" alt=""></a>
                                    <div class="post-date">
                                ...
                                <div class="post-content">
                                    <h4 class="post-name"><a href="blog-post" class="linktopost">Arias Farms and Feeds: The #1 in providing natural and healthy foods free from...</a></h4>
                                    <div class="post-meta">
                                    ...
                                    <p class="excerpt">At Arias Farms and Feeds Ltd, our mission is to provide natural and healthy foods free from cancerous agents, ensuring that...</p>
                                    <div class="group-buttons">
                                        <a href="blog-post" class="btn readmore">continue reading</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="post-item style-bottom-info layout-02">
                                ...
                                <div class="post-content">
                                    <h4 class="post-name"><a href="blog-post.html" class="linktopost">Arias Farms and Feeds: The #1 in providing natural and healthy foods free from...</a></h4>
                                    <div class="post-meta">
                                        <!--<a href="#" class="post-meta__item author"><img src="assets/images/home-03/post-author.png" width="28" height="28" alt=""><span>Admin</span></a>
                                        <a href="#" class="post-meta__item btn liked-count">2<span class="biolife-icon icon-comment"></span></a>
                                        <a href="#" class="post-meta__item btn comment-count">6<span class="biolife-icon icon-like"></span></a>-->
                        ...
                        <li>
                            <div class="post-item style-bottom-info layout-02">
                                <div class="thumbnail">
                                    <a href="#" class="link-to-post"><img src="assets/images/our-blog/demo-1.jpg" width="370" height="270" alt=""></a>
                                    <div class="post-date">
                                        <span class="date">01</span>
                                        <span class="month">August</span>
                                    </div>
