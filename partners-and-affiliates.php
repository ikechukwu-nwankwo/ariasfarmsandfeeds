...
<body class="biolife-body">
    ...
    <div class="hero-section hero-background">
        <h1 class="page-title">Partners and Affiliates</h1>
    </div>
    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                ...
                <li class="nav-item"><span class="current-page">Partners and Affiliates</span></li>
            </ul>
        </nav>
    </div>
        ...
        <div id="main-content" class="main-content">
			<div>
                <div class="container">
					...
					<img src="assets/images/page_under_construction.jpg" width="600" height="270" alt="">
