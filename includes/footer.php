            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-9">
                        <section class="footer-item">
                            <a href="home-03-green.html" class="logo footer-logo"><img src="assets/images/ariasfarmslogo_44.png" alt="ariasogo" width="135" height="36"></a>
                            <div class="footer-phone-info">
                                <i class="biolife-icon icon-head-phone"></i>
                                <p class="r-info">
                                    <span>Got Questions ?</span>
                                    <span>(234) 806-153-3444</span> 
									<span>(234) 705-358-3429</span> 
									<span>(234) 907-032-3170</span>
                                </p>
                            </div>
                        ...
                        <section class="footer-item">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-xs-6">
                                    <div class="wrap-custom-menu vertical-menu-2">
                                        <ul class="menu">
                                            ...
                                            <li><a href="our-mission-vision" target="_blank">Our Mission & Vision</a></li>
                                            <li><a href="careers" target="_blank">Careers</a></li>
                                            <li><a href="farms" target="_blank">Our Farms</a></li>
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-6">
                                    <div class="wrap-custom-menu vertical-menu-2">
                                        <ul class="menu">
                                            <li><a href="media-gallery" target="_blank">Media Gallery</a></li>
                                            <li><a href="downloads" target="_blank">Downloads</a></li>
                                            <li><a href="partners-and-affiliates" target="_blank">Partners & Affiliates</a></li>
                                            <li><a href="shop" target="_blank">Shop</a></li>
                                            <li><a href="team" target="_blank">Team</a></li>
                                            <li><a href="blog-v02" target="_blank">Our Blog</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 md-margin-top-5px sm-margin-top-50px xs-margin-top-40px">
                        <section class="footer-item">
                                ...
                                <ul class="contact-lines">
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">Plot 14 Farm Road, Abara Etche, Off Rivers State University of Agriculture Extension, Rivers State
											</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">Phone: (+234)-806-153-3444</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-letter"></i>
                                            <b class="desc">Email: ariasfarmsandfeeds@gmail.com ||  ariasfarmsandfeedsltd@yahoo.com</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                            ...
                            <div class="biolife-social inline">
                                <ul class="socials">
                                    <li><a href="https://x.com/ariasfarmsnfeed" title="twitter" class="socail-btn"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                    <li><a href="https://facebook.com/ariasfarmsandfeedsltd" title="facebook" class="socail-btn"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                    <li><a href="https://youtube.com/ariasfarmsnfeeds" title="youtube" class="socail-btn"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                                    <li><a href="https://instagram.com/ariasfarmsfeedsltd" title="instagram" class="socail-btn"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                </ul>
                            </div>
                        </section>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12">
						<p>&copy; <span id="year"></span> Arias Farms and Feeds Ltd. All rights reserved.</p>
					</div>
                    <div class="col-lg-6 col-sm-6 col-xs-12">
    ...
    <div class="mobile-block-global">
        ...
        <div class="block-global-contain">
            ...
            <div class="glb-item currency">
                ...
                <ul class="list">
				    <li class="list-item"><a href="#">NGN (Naira)</a></li>
